...
# Generated: Wed May  8 13:48:26 2013
##################################################
...
class rx_noaa_hrpt(grc_wxgui.top_block_gui):
...
if __name__ == '__main__':
	...
	tb = rx_noaa_hrpt(satellite=options.satellite, gain=options.gain, freq=options.freq, sync_check=options.sync_check, side=options.side, rate=options.rate, frames_file=options.frames_file, baseband_file=options.baseband_file)
	tb.Run(True)
