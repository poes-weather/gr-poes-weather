...
# Generated: Wed Dec 15 21:23:00 2010
##################################################
...
class fy1_hrpt_bb_to_frames_nogui(gr.top_block):

	def __init__(self, sync_check=False, decim=16, satellite='FENGYUN-1D', baseband_file=os.environ['HOME'] + '/FENGYUN-1D.dat', frames_file=os.environ['HOME'] + '/FENGYUN-1D.hrpt'):
		gr.top_block.__init__(self, "Feng Yun 1 HRPT Baseband To Frames")
...
if __name__ == '__main__':
	...
	tb = fy1_hrpt_bb_to_frames_nogui(sync_check=options.sync_check, decim=options.decim, satellite=options.satellite, baseband_file=options.baseband_file, frames_file=options.frames_file)
	tb.run()
