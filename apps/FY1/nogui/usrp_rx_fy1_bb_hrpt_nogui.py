...
# Generated: Wed Dec 15 21:23:03 2010
##################################################
...
class usrp_rx_fy1_bb_hrpt_nogui(gr.top_block):

	def __init__(self, gain=35, side="A", sync_check=False, freq=1700.5e6, satellite='FENGYUN-1D', frames_file=os.environ['HOME'] + '/FENGYUN-1D.hrpt', baseband_file=os.environ['HOME'] + '/FENGYUN-1D.dat', decim=16):
...
if __name__ == '__main__':
	...
	tb = usrp_rx_fy1_bb_hrpt_nogui(gain=options.gain, side=options.side, sync_check=options.sync_check, freq=options.freq, satellite=options.satellite, frames_file=options.frames_file, baseband_file=options.baseband_file, decim=options.decim)
	tb.start()
