...
# Generated: Wed May  8 14:18:11 2013
##################################################
...
class pw_rx_noaa_hrpt_2(grc_wxgui.top_block_gui):
	...
	def __init__(self, satellite='NOAA-XX', gain=35, freq=1698e6, sync_check=False, side="A:0", rate=2e6, frames_file=os.environ['HOME'] + '/data/noaa/frames/NOAA-XX.hrpt'):
		...
		self.poesweather_noaa_hrpt_deframer2_0 = poesweather.noaa_hrpt_deframer2(5)
		...
		self.connect((self.poesweather_noaa_hrpt_deframer2_0, 0), (self.blocks_file_sink_0, 0))
		self.connect((self.digital_binary_slicer_fb_0, 0), (self.poesweather_noaa_hrpt_deframer2_0, 0))
