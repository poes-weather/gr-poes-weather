...
# Description: Meteor M N1HRPT Receiver
# Generated: Wed Dec 15 21:21:23 2010
##################################################
...
class usrp_rx_mn1_hrpt_nogui(gr.top_block):

	def __init__(self, frames_file=os.environ['HOME'] + '/METEOR-M-1.hrpt', decim=32, side="A", gain=35, satellite='METEOR-M-1', sync_check=False, freq=1700e6):
...
if __name__ == '__main__':
	...
	tb = usrp_rx_mn1_hrpt_nogui(frames_file=options.frames_file, decim=options.decim, side=options.side, gain=options.gain, satellite=options.satellite, sync_check=options.sync_check, freq=options.freq)
	tb.start()
