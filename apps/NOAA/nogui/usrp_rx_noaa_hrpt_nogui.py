...
# Generated: Wed Dec 15 21:25:07 2010
##################################################
...
class usrp_rx_noaa_hrpt_nogui(gr.top_block):
...
if __name__ == '__main__':
	...
	tb = usrp_rx_noaa_hrpt_nogui(sync_check=options.sync_check, decim=options.decim, freq=options.freq, gain=options.gain, side=options.side, frames_file=options.frames_file, satellite=options.satellite)
	tb.start()
