...
# Generated: Wed Dec 15 21:25:03 2010
##################################################
...
class usrp_rx_noaa_bb_hrpt_nogui(gr.top_block):

	def __init__(self, decim=32, freq=1698e6, gain=35, side="A", frames_file=os.environ['HOME'] + '/NOAA-XX.hrpt', baseband_file=os.environ['HOME'] + '/NOAA-XX.dat', satellite='NOAA-XX', sync_check=False):
...
if __name__ == '__main__':
	...
	tb = usrp_rx_noaa_bb_hrpt_nogui(decim=options.decim, freq=options.freq, gain=options.gain, side=options.side, frames_file=options.frames_file, baseband_file=options.baseband_file, satellite=options.satellite, sync_check=options.sync_check)
	tb.start()
